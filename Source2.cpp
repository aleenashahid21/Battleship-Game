...
//}
//
//void placeship(int grid[10][10], sf::RenderWindow& window)
//{
//    const int tileSize = 40;
//    const int gridOffset = 50;
//
//    RectangleShape tile(sf::Vector2f(tileSize - 2, tileSize - 2));
//    tile.setOutlineThickness(1);
//    tile.setOutlineColor(sf::Color::Black);
//
//    RectangleShape shipTile(sf::Vector2f(tileSize - 4, tileSize - 4));
//    shipTile.setFillColor(sf::Color::Green);
//
...
//                    spacePressed = true;
//                    updateScreen = true; // Update screen on toggle
//                }
//            }
...
//                        }
//                        currentShipIndex++;
//                        updateScreen = true; // Update screen after placement
//                    }
//                }
//            }
//        }
...
//                    tile.setFillColor(grid[i][j] == 1 ? sf::Color::Blue : sf::Color::White);
//                    window.draw(tile);
//                }
//            }
//
...
//                        shipTile.setFillColor(canPlace ? sf::Color::Green : sf::Color::Red);
...
//        }
//
//        sf::sleep(sf::milliseconds(16)); // Frame limiter (~60 FPS)
//    }
//}
//
//
...
//{
//    // Load the font for the title (Ensure arial.ttf exists in your working directory)
//    Font font1;
...
//
//    if (Mouse::isButtonPressed(Mouse::Left) && !clickProcessed) // Ensure mouse click is detected 
//    {
//        clickProcessed = true;
//
...
//
//        if (isValidCell(row, col)) // Ensure the cell clicked is within bounds
//        {
...
//    {
//        clickProcessed = false; // Reset click lock when button is released
//    }
//}
//
//
...
//    }
//
//    // Create text to display the result
//    Text gameOverText(resultMessage, font, 50);
...
//    // Create text for the final scores
//    Text playerFinalScore("Your Score: " + std::to_string(playerScore), font, 30);
...
//
//    Text aiFinalScore("AI's Score: " + std::to_string(aiScore), font, 30);
//    aiFinalScore.setFillColor(Color::Black);
//    aiFinalScore.setPosition(window.getSize().x / 2.0f - aiFinalScore.getLocalBounds().width / 2.0f,
...
//    Music Gameovermusic;
//
//    /* if (!Gameovermusic.openFromFile("664606_mt4000_game-over-low.ogg"))
//     {
...
//
//        // Draw grids
//        drawgrid(window, playergrid, offsetX, offsetY, true, cellSize, "Player's Grid");
//        drawgrid(window, opponentgrid, offsetX + 500, offsetY, false, cellSize, "Opponent's Grid");
//
//        if (!gameOver) {
//            if (isPlayerTurn) {
//                // Player's turn
//                playerturn(window, opponentgrid, offsetX + 500, offsetY, cellSize, isPlayerTurn);
...
//
//        // Display scores
//        Text playerScoreText("Player Score: " + std::to_string(playerScore), font, 24);
//        playerScoreText.setFillColor(Color::Black);
//        playerScoreText.setPosition(offsetX, offsetY - 60); // Position above the player's grid
//
//        Text aiScoreText("AI Score: " + std::to_string(aiScore), font, 24);
